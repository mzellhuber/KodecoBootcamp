...
class TaskStore: ObservableObject {
    ...
    init() {
        self.tasks = [
            ...
            Task(id: UUID(), title: "Read Book", isCompleted: true, notes: "Read next chapter of 'The SwiftUI Handbook'."),
            Task(id: UUID(), title: "Gardening", isCompleted: true, notes: "Water the garden and trim the hedges.")
        ]
    }
